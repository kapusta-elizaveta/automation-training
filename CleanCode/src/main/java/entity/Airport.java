...
public class Airport {
    ...
    public List<PassengerPlane> getAllPassengerPlanes() {
    ...
    public PassengerPlane getPassengerPlaneWithMaxPassengersCapacity() {
        PassengerPlane planeWithMaxCapacity = getAllPassengerPlanes().get(0);
        for (PassengerPlane passengerPlane : getAllPassengerPlanes()) {
    ...
    public List<MilitaryPlane> getTransportMilitaryPlanes() {
        ...
        for (MilitaryPlane militaryPlane : getAllMilitaryPlanes()) {
    ...
    public List<MilitaryPlane> getBomberMilitaryPlanes() {
        ...
        for (MilitaryPlane plane : getAllMilitaryPlanes()) {
