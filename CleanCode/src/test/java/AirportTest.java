...
public class AirportTest {
    private static List<Plane> planes = Arrays.asList(
            ...
            new ExperimentalPlane("Bell X-14", 277, 482, 500, ExperimentalPlaneType.HIGH_ALTITUDE, PlaneClassificationLevel.SECRET),
            new ExperimentalPlane("Ryan X-13 Vertijet", 560, 307, 500, ExperimentalPlaneType.VTOL, PlaneClassificationLevel.TOP_SECRET)
    );
    ...
    public void testExperimentalPlanesHaveClassificationLevelHigherThanUnclassified(){
        ...
        for(ExperimentalPlane experimentalPlane : experimentalPlanes) {
            if (experimentalPlane.getPlaneClassificationLevel() == PlaneClassificationLevel.UNCLASSIFIED) {
